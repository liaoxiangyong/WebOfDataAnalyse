...
import {get_features,get_files,file_select,update_config,update_model,feature_change,change_model_type,auto_feature,change_btn_state,change_feature_spin,select_method,
    change_step,update_when_change,add_model_args,update_model_info,get_models,update_edit_true,update_arg_value,do_init,change_select_way} from '../../redux/actions/AddConfigAction'
...
class AddConfig extends React.Component {
    ...
    render() {
        let {fileId,files,featureList,targetKeys,modelType,stepCurrent,modelTypeName,models,featureSpinLoading,methodId,featureResult,
        ...
        //     trainFeatureInfo = featureList.filter(function (item) {
        //         let info = [];
        ...
        const rightDisplay = stepCurrent >= stepContent.length-1 ? 'none' : 'block';
